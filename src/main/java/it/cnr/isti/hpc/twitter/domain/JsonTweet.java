...
public class JsonTweet extends BasicTweet implements Tweet  {
	...
	private static final Logger logger = LoggerFactory.getLogger(JsonTweet.class);
	/** google json parser */
...
//	/**
//	 * Generates a dictionary with the conversion of the hashtags segmented. <br>
//	 * example <br>
//	 * wishyouwerehere -> with you were here diego -> diego isticnr -> isti cnr
//	 * 
//	 * @param hs
...
//
//	/**
//	 * returns the text of the twit, replacing the hashtags with thir segmented
//	 * hashtags.<br />
...
//	}
	...
	/**
	 * Takes in input the json describing a tweet and returns an Tweet object with
	...
	public static JsonTweet parseTwitFromJson(Reader tweet)
		...
		try {
			...
			logger.error("error parsing the twit ({}) ", e.getMessage());
...
//	 * (non-Javadoc)
//	 * 
//	 * @see it.cnr.isti.hpc.twitter.domain.TweetInterface#isOnlyURLAndHashtags()
//	 */
...
//	 * tab separed by a tab. Each couple contains two hashtag x,y if x is before
//	 * than y in the twit. example: twit: my name is #asd and #today I'm #happy
